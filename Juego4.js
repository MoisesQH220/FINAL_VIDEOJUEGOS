...
var Juego4={
	preload: function () {
		...
		juego.load.image('malo','img/chile.png');
		juego.load.image('bg4','img/bg4.jpg');
	...
	create: function(){
		//BASE
		fondojuego = juego.add.tileSprite(0,0,400,540,'bg4');
		...
		txtVidas = juego.add.text(360, 20, "1", {font: "14px Arial", fill: "#000"});
	},
